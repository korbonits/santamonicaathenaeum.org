...
export const ACQUISITIONS: Acquisition[] = [
  ...
  { title: "The Harvard Classics", author: "Charles W. Eliot, ed.", note: "51 vols." },
  { title: "Great Books of the Western World", author: "Robert Maynard Hutchins, ed.", note: "54 vols., Britannica" },
